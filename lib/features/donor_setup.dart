...
class DonorSetup extends StatefulWidget {
  @override
  _DonorSetupState createState() => _DonorSetupState();
}

class _DonorSetupState extends State<DonorSetup> {
        ...
        builder: (context) => (isLoading)
            ...
            : Container(
                ...
                child: Column(children: <Widget>[
                  OkoaLifeAppBar(title: 'Donor Details Page'),
                  Expanded(
                    child: Padding(
